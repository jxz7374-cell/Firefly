...
pinned: true
description: "这是一篇专门给新手准备的博客使用说明。"
image: "./cover.avif"
tags: ["尼克狐尼克", "博客", "Markdown", "指南"]
category: 博客指南
---
...
如果你是第一次接触博客项目，只记住下面这三件事就够用了：

1. 发新文章：在 `src/content/posts/` 里新建一个 `.md` 文件。
2. 删除文章：把对应的 `.md` 文件删掉。
3. 改站点信息：去 `src/config/` 目录里改配置。

如果你不想手动写文件名，也可以直接运行下面这条命令自动生成文章模板：
...
title: 如何使用尼克狐尼克博客
published: 2023-09-09
slug: how-to-use-nick-blog
---
```
文件：`src/content/posts/如何使用尼克狐尼克博客.md`

URL：`/posts/how-to-use-nick-blog`
