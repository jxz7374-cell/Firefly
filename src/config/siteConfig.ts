...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "一个适合记录日常与想法的个人博客",

	// 站点 URL
	// 这里先使用 GitHub Pages 提供的免费地址。
	// 如果你以后买了自己的域名，再把这里替换成自己的正式网址即可。
	site_url: "https://jxz7374-cell.github.io/Firefly/",

	// 站点描述
	description:
		"尼克狐尼克的个人博客，基于 Astro 搭建，保留了清新、轻盈的参考站风格，适合用来记录文章、日常和个人收藏。",
	...
	navbar: {
		...
		logo: {
			type: "image",
			// 这里改成了 public 目录里的本地 SVG，后续你想换图，直接替换文件即可。
			value: "/assets/images/nick-logo.svg",
			alt: "尼克狐尼克",
		},
		// 导航栏标题
		title: "尼克狐尼克",
